...
public class Set implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        if(hasVar){
            ...
            ctxt.generateJavaSource("            ajava.beans.PropertyDescriptor " + pdName + "[] = ajava.beans.Introspector.getBeanInfo(" + targetName + ".getClass()).getPropertyDescriptors();");
            ...
            ctxt.generateJavaSource("        } catch (ajava.beans.IntrospectionException ex) {");
            ctxt.generateJavaSource("            throw new JspException(ex);");
