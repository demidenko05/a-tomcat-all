...
import ajava.beans.PropertyEditorManager;
...
public class JspRuntimeLibrary {
   ...
   // __begin convertMethod
                                        ...
                                        throws JasperException
    {
        ...
        try {
            ajava.beans.BeanInfo info
                = ajava.beans.Introspector.getBeanInfo(bean.getClass());
            if ( info != null ) {
                ajava.beans.PropertyDescriptor pd[]
...
**/
    ...
    throws JasperException {
        ...
        try {
            ajava.beans.BeanInfo info
                = ajava.beans.Introspector.getBeanInfo(beanClass);
            if ( info != null ) {
                ajava.beans.PropertyDescriptor pd[]
                    = info.getPropertyDescriptors();
                for (int i = 0 ; i < pd.length ; i++) {
